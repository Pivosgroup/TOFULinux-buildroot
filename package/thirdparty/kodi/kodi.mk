...
KODI_VERSION = 3b742d11518b556809cdb610f3e42005f260be21
...
define KODI_INSTALL_UPNP_ICONS
  cp -f package/thirdparty/kodi/upnp_icons/*.png $(TARGET_DIR)/usr/share/kodi/media/
endef

define KODI_COPY_BUILD_ID
  mkdir -p $(TARGET_DIR)/etc
  cp -f $(BUILD_DIR)/kodi-$(KODI_VERSION)/VERSION $(TARGET_DIR)/etc/build.id
endef
...
KODI_POST_INSTALL_TARGET_HOOKS += KODI_INSTALL_UPNP_ICONS
KODI_POST_INSTALL_TARGET_HOOKS += KODI_COPY_BUILD_ID
